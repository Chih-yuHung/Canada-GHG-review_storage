...
GHG.table.CH4 <- data.frame(lapply(GHG.table.CH4,function(x) {
                            gsub("OB, OB", "OB", x)
                }))
...
#Change the name
names(GHG.table.CH4) <- c("ID", "Authors and year", "Region", "Animal types","Manure type", "Methods", "Year", "GHG types")
