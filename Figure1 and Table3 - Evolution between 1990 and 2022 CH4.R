...
#Table 4 Change between 2005 and 2022
...
#Export tables
#Table between 1990 and 2022
write_xlsx(list(Evolution=CH4_Evolution),
           file = "output/Evolution of CH4 by livestock between 1990 and 2022.xlsx",
           col.names = T, row.names = T)
#Table 4 Change between 2005 and 2022
gt_CH4_Change %>%
  gtsave("Change in CH4 emissions and animals between 2005 and 2022.docx")
...
Graph_Evolution <-  
  ggplot(data = na.omit(CH4_Evolution_Graph),
         aes(x = Year, 
             ...
             color = Livestock)) +
  geom_line(lwd =1.1) +
  labs(x = "Publication Year", y = "CH4 emissions (kT CO2 eq)") +
...
#Export figure
ggsave("output/Figure - Evolution between 1990 and 2022 CH4.png", Graph_Evolution,
